...
<html>
<head>
<title>Launch Page: Dungeon Crawl Classics Dwarf Character Generator Version 3</title>
...
<body>
	...
	<section>
		...
		<h1><img src="images/title.png" alt="Dungeon Crawl Classics Dwarf Character Generator Version 3" class="image" /></h1>
        ...
        <p><a href="https://www.oldschooladventures.org/dcc/dwarf/"  class="text_link" target="_blank"><span class="bold">Dwarves, Dwarfs & Mighty Deeds: A DCC Fan Site</span></a></p>

        <p><a href="https://www.tasaka-games.com/dcc/more/classes/dwarf/"  class="text_link" target="_blank"><span class="bold">Fantastic Adventures and the Distgruntled Gong Farmer: A DCC Adventure Module</span></a></p>
		...
		<form action="" id ="DwarfFormV3"  target="_blank" method="post">
    ...
    <div class="content9">
        ...
        <br/>
            ...
            <span class="formIputDescription">Armour:</span>	
			  <select id="armourV3" name="theArmour" class="alignmentBox">			
				...
				<option value="6" selected>Chainmail armour</option>
           ...
           <br/>
            ...
            <span class="formIputDescription">Lucky Weapon:</span>	
			  <select id="luckyWeaponV3" name="theLuckyWeapon" class="alignmentBox">			
				...
				<option value="13">Longsword</option>
				...
				<option value="22" selected>Warhammer</option>
			  </select>
        ...
        $("#generate_charactersWarriorV3").click(function(){
         ...
         $("#DwarfFormV3").attr('action', "character3/dccDwarf.php");
